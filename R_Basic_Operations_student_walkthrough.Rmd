...
```{r}
sprintf("%s ate %d cookies.", "John", 4)
...
1.  Create two strings with your first and last name, respectively. Then concatenate them, and print the new value as "My name is \<your newly created concatenated variable will go here\>"
    ...
    ```{r}
    my_first_name <- "Satwik"
    my_last_name <- "Pradhan"
    my_full_name <- paste(first_name, last_name)
...
2.  What values can a BOOLEAN contain?
    ...
    Boolean expressions are logical statements that are either true or false. Booleans are typically used as the result of a comparison.
